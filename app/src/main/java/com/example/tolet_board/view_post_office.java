...
public class view_post_office extends AppCompatActivity {
    ...
    public void loadData()
    {
        ...
        Cursor cursor=databaseHelper4.showAllData();
        ...
        final ArrayAdapter<String> adapter=new ArrayAdapter<String>(getApplicationContext(),R.layout.list_item_office,R.id.TextViewUsernameID,listData);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                while(cursor.moveToNext())
                {
                    if(beforeFirstDot.equals(cursor.getString(0)))
                    {
                        ...
                        Intent intent =new Intent(view_post_office.this,show_description_office.class);
