...
public class DatabaseHelper1 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME1="homedetails1.db";
    private static final String TABLE_NAME4="home_details1";
   ...
   // private static final String PASSWORD="Password";
    ...
    private static final int VERSION_NUMBER4=11;
    ...
    public DatabaseHelper1( Context context) {
        super(context, DATABASE_NAME1, null, VERSION_NUMBER4);
