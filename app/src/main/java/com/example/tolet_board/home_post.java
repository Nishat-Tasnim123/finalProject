...
public class home_post extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteDatabase sqLiteDatabase= databaseHelper3.getWritableDatabase();
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.home_postButtonId) {
            ...
            if (Ownername.equals("") && Title.equals("") && Rent.equals("") && Month.equals("") && phone_Number.equals("") && location.equals("") && Description.equals("")) {
                ...
                long rowId = databaseHelper3.saveData(Ownername,Title,Rent,Month,phone_Number, location,Description);
            ...
            Intent intent = new Intent(getApplicationContext(), view_posts.class);
